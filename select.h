...
void nselect(population *old_pop_ptr,population *pop2_ptr)
{
  ...
  old_pop_ptr->sp_ptr->NB_ptr = &(old_pop_ptr->sp_ptr->Neighbors[0]);
  
  pop2_ptr->ind_ptr= &(pop2_ptr->ind[0]);
  
  pop2_ptr->sp_ptr = &(pop2_ptr->sp[0]);
  
  pop2_ptr->sp_ptr->NB_ptr = &(pop2_ptr->sp_ptr->Neighbors[0]);
  
  //j =  &(old_pop_ptr->ind[popsize-1]);
  j = &(old_pop_ptr->sp_ptr->Neighbors[popsize-1]);
  ...
  for(n = 0,k = 0;n < popsize;n++,k++)
	...
	rnd = (popsize-2)/2;*/
	  ...
	  j = &(old_pop_ptr->sp_ptr->Neighbors[rnd2]);
	...
	rnd1 = (popsize - 4)/2;*/
	  ...
	  j1 = &(old_pop_ptr->sp_ptr->Neighbors[rnd1]);
	  
      old_pop_ptr->sp_ptr->NB_ptr = j;
	  ptry = old_pop_ptr->sp_ptr->NB_ptr;
	  old_pop_ptr->ind_ptr = &(old_pop_ptr->ind[*ptry]);
      ...
      old_pop_ptr->sp_ptr->NB_ptr = j1;
	  ptry2 = old_pop_ptr->sp_ptr->NB_ptr;
	  old_pop_ptr->ind_ptr = &(old_pop_ptr->ind[*ptry2]);
